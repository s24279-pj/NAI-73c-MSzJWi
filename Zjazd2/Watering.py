...
rule12 = ctrl.Rule(humidity_soil['good'] & humidity_air['poor'] & temperature['hot'], time['long'])
...
watering.input['humidity air'] = 40
watering.input['humidity soil'] = 34
watering.input['temperature'] = 20
